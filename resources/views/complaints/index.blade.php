                            ...
                            <table class="table">
                                ...
                                @foreach($complaints as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/complaint/' . $item->id) }}" title="View complaint"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            <!--< a href="{{ url('/complaint/' . $item->id . '/edit') }}" title="Edit complaint"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
